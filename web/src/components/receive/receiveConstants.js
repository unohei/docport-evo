...
//
// navBg 系トークン: グローバルサイドバー・トップバーの背景に使用。
// 強い濃ネイビーを避け、ロゴ・ログイン画面と統一した柔らかいブルーグレーへ。
// navy は見出し文字色として残存しているため、ここでは別トークン化している。
export const DP = {
  ...
  white:       "#FFFFFF",
  // ---- クロム（サイドバー / トップバー）専用ブルーグレー ----
  navBg:       "#5E6F96",                   // 基本背景（サイドバー / トップバー）
  navBgHover:  "#7182A8",                   // ナビ項目 hover
  navBgActive: "#4F5D87",                   // ナビ項目 active（選択中タブ）
};
